...
import com.monitor.health.databinding.FragmentBloodOxygenBinding;
import com.monitor.health.databinding.FragmentElectrocardiogramBinding;
...
public class BloodOxygenFragment extends Fragment implements QuickActionsHandler {
...
// Each include now has a real root you can grab by id
        ...
        binding.chartIcon.setOnClickListener(chart -> {
            ...
            intent.putExtra("backgroundColor", "BloodOxygenFragment");
        ...
        vm.getOxygen().observe(getViewLifecycleOwner(), g -> {
            ...
            vm.getOxygenUpdatedAt().observe(getViewLifecycleOwner(), timeAgo -> {
                ...
                vm.getOxygenEventDescription().observe(getViewLifecycleOwner(), bpm -> {
                    ...
                    double value = g.get(1).getConvertedValues().get(0).getValue();
                    if (value == 0) {
                        binding.tvValueBg.setText("---");
                    } else {
                        binding.tvValueBg.setText(String.valueOf(Math.round(value)));
                    }

                    binding.tvBPM.setText("BMI: "+Math.round(g.get(0).getConvertedValues().get(0).getValue()));
        ...
        HealthManager.getInstance(requireContext())
                .startBloodOxygenMeasurement(new HealthManager.ValueCallback<Integer>() {
                    ...
                    public void onValue(Integer spo2) {
                        ...
                        Log.wtf("spo2-here", "Blood pressure value: "+spo2);
                        uiHandler.postDelayed(() -> {
                            if (binding == null) return;

                            if(spo2 != 0) {

                                binding.tvValueBg.setText(spo2+"");
    ...
    public void onResume() {
        ...
        if (NetworkUtils.isInternetConnected(requireContext())) {
            //Send all offline data to the server
            vm.fetchLatest(
            ...
            if (oximeter != null) {
                ...
                Log.d(TAG, "OnResume here. pulse data" + oximeter.getPulseRate());
                Log.d(TAG, "OnResume here. 1" + oximeter.getOxygen());
                binding.tvValueBg.setText(oximeter.getPulseRate() + "");
                binding.tvBPM.setText("BPM: " + oximeter.getOxygen());
...
//        Oximeter oximeter = new Oximeter(51, 0, 2, "123");
//        databaseClient.getAppDatabase().oximeterDao().insertOximeter(oximeter);
//        Oximeter oximeter2 = new Oximeter(52, 0, 2, "123");
//        databaseClient.getAppDatabase().oximeterDao().insertOximeter(oximeter2);
//        Oximeter oximeter3 = new Oximeter(53, 0, 2, "123");
//        databaseClient.getAppDatabase().oximeterDao().insertOximeter(oximeter3);
//        Oximeter oximeter4 = new Oximeter(54, 0, 2, "123");
//        databaseClient.getAppDatabase().oximeterDao().insertOximeter(oximeter4);
//        Oximeter oximeter5 = new Oximeter(55, 0, 2, "123");
//        databaseClient.getAppDatabase().oximeterDao().insertOximeter(oximeter5);
